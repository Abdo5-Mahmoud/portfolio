...
//   return (
//     <section className="flex flex-col md:flex-row gap-8 my-16  justify-center max-w-7xl mx-auto px-4 ">
...
//         </h3>
//         <ul className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 gap-x-6 text-lightBlue list-disc text-lg lg:gap-x-7">
//           <li>React.js</li>
//           <li>Next.js</li>
